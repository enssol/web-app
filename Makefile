...
pkgdatadir = $(datadir)/web-app
pkgincludedir = $(includedir)/web-app
pkglibdir = $(libdir)/web-app
pkglibexecdir = $(libexecdir)/web-app
...
DIST_COMMON = $(srcdir)/Makefile.am $(top_srcdir)/configure \
	$(am__configure_deps) $(dist_config_DATA) $(am__DIST_COMMON)
...
AUTOMAKE = ${SHELL} '/Users/adriangallo/web-app/build/missing' automake-1.17
AWK = gawk
BIN_DIR = bin
BISON = bison
BUILD_DIR = build
...
GTKDOC_CHECK_PATH = /opt/homebrew/bin/gtkdoc-check
GTKDOC_DEPS_CFLAGS = -I/opt/homebrew/Cellar/glib/2.82.2/include -I/opt/homebrew/Cellar/glib/2.82.2/include/glib-2.0 -I/opt/homebrew/Cellar/glib/2.82.2/lib/glib-2.0/include -I/opt/homebrew/opt/gettext/include -I/opt/homebrew/Cellar/pcre2/10.44/include -I/Library/Developer/CommandLineTools/SDKs/MacOSX15.sdk/usr/include/ffi
GTKDOC_DEPS_LIBS = -L/opt/homebrew/Cellar/glib/2.82.2/lib -lgobject-2.0 -lglib-2.0 -L/opt/homebrew/opt/gettext/lib -lintl
GTKDOC_MKPDF = /opt/homebrew/bin/gtkdoc-mkpdf
GTKDOC_REBASE = /opt/homebrew/bin/gtkdoc-rebase
...
install_sh = ${SHELL} /Users/adriangallo/web-app/build/install-sh
...
uninstall-am: uninstall-dist_configDATA uninstall-local
...
.PHONY: $(am__recursive_targets) CTAGS GTAGS TAGS all all-am all-local \
	...
	install-data-local install-dist_configDATA install-dvi \
