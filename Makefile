...
install_sh = ${SHELL} /home/ubuntu/web-app/build/install-sh
...
distclean-generic:
	...
	-test -z "$(SRC_DIR)/$(DEPDIR)/$(am__dirstamp)" || rm -f $(SRC_DIR)/$(DEPDIR)/$(am__dirstamp)
	-test -z "$(SRC_DIR)/$(am__dirstamp)" || rm -f $(SRC_DIR)/$(am__dirstamp)
