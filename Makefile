...
am__DIST_COMMON = $(srcdir)/Makefile.in $(srcdir)/config.h.in \
	...
	$(top_srcdir)/build/missing AUTHORS COPYING ChangeLog INSTALL \
	NEWS README.md build/ar-lib build/compile build/config.guess \
...
distclean-generic:
	...
	-$(am__rm_f) $(SRC_DIR)/$(DEPDIR)/$(am__dirstamp)
	-$(am__rm_f) $(SRC_DIR)/$(am__dirstamp)
